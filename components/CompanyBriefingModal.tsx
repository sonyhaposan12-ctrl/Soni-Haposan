        ...
        if (isLoading) {
            return (
                <div className="flex flex-col items-center justify-center h-full text-gray-400">
                    ...
                    <p className="mt-4 text-lg">{translations.researching(companyName)}</p>
                    <p className="text-sm text-gray-500">{translations.pleaseWait}</p>
                </div>
            );
        }
        ...
        if (error) {
            return (
                 <div className="flex flex-col items-center justify-center h-full text-red-300 text-center">
                    ...
                    <h3 className="text-lg font-semibold">{translations.briefingErrorTitle}</h3>
            ...
            return (
                <div>
                    ...
                    {briefingData.sources && briefingData.sources.length > 0 && (
                        <div className="mt-6">
                            <h4 className="text-lg font-semibold text-gray-300 border-t border-gray-600 pt-4">{translations.sources}</h4>
            ...
            >
                <header className="p-4 border-b border-gray-700 flex justify-between items-center flex-shrink-0">
                    <h2 id="briefing-title" className="text-xl font-bold flex items-center gap-2">
                        ...
                        {translations.companyBriefing}: {companyName}
                    </h2>
                    <button onClick={onClose} className="p-2 rounded-full hover:bg-gray-700" aria-label={translations.closeBriefing}>
